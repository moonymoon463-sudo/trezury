-- Enhanced security measures for customer PII protection - Fixed Version
...
-- 3. Create enhanced audit trigger for profiles table (UPDATE only)
...
-- Apply the enhanced audit trigger for UPDATE operations
