-- Fix critical security policies for production readiness
...
-- 5. Create admin role for sensitive operations
INSERT INTO public.profiles (id, email, metadata) 
VALUES (
  '00000000-0000-0000-0000-000000000000'::uuid,
  'admin@system.internal',
  '{"role": "admin", "permissions": ["view_all_kyc", "manage_users"]}'::jsonb
