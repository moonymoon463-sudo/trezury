...
const BuySellHub = () => {
  ...
  return (
    <AppLayout headerProps={{ showBackButton: true, backPath: "/" }} showBottomNavOnAllScreens={true}>
      <div className="mobile-fit md:max-w-2xl mx-auto space-y-3 h-[calc(100vh-8rem)] overflow-y-auto">
        <div className="mobile-zoom">
          {/* Gold Price Section */}
          <div className="bg-card rounded-xl p-4 sm:p-3">
          ...
          <div>
            <div 
              ...
              className="bg-card rounded-xl p-5 sm:p-4 cursor-pointer hover:bg-accent transition-colors"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-foreground text-xl sm:text-lg font-bold mb-1">Buy Gold</h3>
          ...
          <div className="flex justify-center">
            <Button 
              className="bg-primary text-primary-foreground font-bold h-14 sm:h-12 text-base sm:text-sm rounded-xl flex items-center justify-center gap-2 hover:bg-primary/90 w-full max-w-xs"
              onClick={() => navigate("/buy-gold")}
            >
